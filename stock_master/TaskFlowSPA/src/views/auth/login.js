export function renderLogin() {
  ...
  <section class="flex items-center justify-center px-6 py-10">
    <div
      class="w-full max-w-xl rounded-4xl border border-blue-100 bg-white p-8 shadow-xl shadow-blue-100/70"
    >
...
import { saveSesion } from "../../services/auth.service";
...
export function setupLogin() {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        if (!user) {
          alertError('Usuario o contrasena incorrecto')
          form.reset()
          return
        }

        // Guardamos sesión antes de navegar para que el guard de requiresAuth la encuentre.
        saveSesion(user)
        navigate("/dashboard")
        alertSuccess('Inicio de sesion exitoso')
